...
series.de.tiempo1 <- db.a.serie.de.tiempo(db1, tipo.variable='t2', conf.especificas = conf.de.interes)
series.de.tiempo2 <- db.a.serie.de.tiempo(db2, tipo.variable='t2', conf.especificas = conf.de.interes)

conf.de.interes <- c(9, 10, 13, 8, 19, 20)
series.de.tiempo3 <- db.a.serie.de.tiempo(db3, tipo.variable='pp', conf.especificas = conf.de.interes)
series.de.tiempo4 <- db.a.serie.de.tiempo(db4, tipo.variable='pp', conf.especificas = conf.de.interes)
...
# cairo_ps("t2_y_pp_series_de_tiempo.eps", width = 13, height = 10)
...
c(plot.xts(as.xts(series.de.tiempo1), main=titulo1, col = c('black', color.i), #legend.loc = TRUE,
  ...
  addLegend("top", 
            ...
            ncol=1,
            bg="white", cex=0.9) )[2]
mtext('°C', side = 2, line = 3.2, font = 1)
# 2
...
c(plot.xts(as.xts(series.de.tiempo3), main=titulo3, col = c('black', color.i), #legend.loc = TRUE,
  ...
  addLegend("topleft", 
            ...
            ncol=1,
            bg="white", cex=0.9) )[2]
mtext(expression('mm day'^-1), side = 2, line = 3.2, font = 1)
